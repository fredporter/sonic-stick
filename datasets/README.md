...
- `windows10_boot`, `media_mode`, and `udos_launcher` are optional capability flags
  for Sonic Stick v2 planning (install mode, media console readiness, launcher support).
